 ...
 */
Rtt_EXPORT void MD4Init( MD4_CTX* context )
{
...
Rtt_EXPORT void MD4Update( MD4_CTX *context, const U8* input, unsigned int inputLen )
{
 ...
 */
Rtt_EXPORT void MD4Final (digest, context)
U8 digest[16];                         /* message digest */
...
/* Encodes input (U32) into output (U8). Assumes len is
     a multiple of 4.
 */
void MD4Encode( U8* output, const U32* input, unsigned int len )
{
  unsigned int i, j;
...
/* Decodes input (U8) into output (U32). Assumes len is
     a multiple of 4.
 */
void MD4Decode( U32* output, const U8* input, unsigned int len )
{
  unsigned int i, j;
