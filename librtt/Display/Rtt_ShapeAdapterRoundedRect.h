...
#ifndef __Rtt_ShapeAdapterRoundedRect__
#define __Rtt_ShapeAdapterRoundedRect__
...
class ShapeAdapterRoundedRect : public ShapeAdapter
{
	public:
		typedef ShapeAdapter Super;

	public:
		static const ShapeAdapterRoundedRect& Constant();

	protected:
		ShapeAdapterRoundedRect();
...
#endif // __Rtt_ShapeAdapterRoundedRect__
