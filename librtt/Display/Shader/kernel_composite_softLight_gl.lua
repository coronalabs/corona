...
--[[
	    ...
	    if( luminance < 0.5 )
	    {
	        result = ( 2.0 * base * blend + base * base * ( 1.0 - 2.0 * blend ) );
	    }
	    else
	    {
	        result = ( sqrt( base ) * ( 2.0 * blend - 1.0 ) + 2.0 * base * ( 1.0 - blend ) );
	    }
...
P_COLOR vec4 FragmentKernel( P_UV vec2 texCoord )
{
    ...
    P_COLOR vec4 resultLuminanceLow = ( 2.0 * base * blend + base * base * ( 1.0 - 2.0 * blend ) );
    P_COLOR vec4 resultLuminanceHigh = ( sqrt( base ) * ( 2.0 * blend - 1.0 ) + 2.0 * base * ( 1.0 - blend ) );
