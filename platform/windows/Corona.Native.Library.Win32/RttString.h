...
#ifndef _RttString_H_
#define _RttString_H_
...
public:
	RttString();
	RttString(const char* utf8Text);
	RttString(const wchar_t* utf16Text);
	RttString(const RttString& string);
	virtual ~RttString();
	...
	void operator=(const RttString& string);
