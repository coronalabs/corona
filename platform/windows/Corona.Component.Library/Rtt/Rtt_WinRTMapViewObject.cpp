...
WinRTMapViewObject::WinRTMapViewObject(const Rect& bounds)
:	Super(bounds)
{
}

WinRTMapViewObject::~WinRTMapViewObject()
{
}
...
bool WinRTMapViewObject::Initialize()
{
...
const LuaProxyVTable& WinRTMapViewObject::ProxyVTable() const
{
	return PlatformDisplayObject::GetMapViewObjectProxyVTable();
}

int WinRTMapViewObject::ValueForKey(lua_State *L, const char key[]) const
{
	Rtt_ASSERT(key);
...
bool WinRTMapViewObject::SetValueForKey(lua_State *L, const char key[], int valueIndex)
{
	Rtt_ASSERT(key);
...
int WinRTMapViewObject::GetUserLocation(lua_State *L)
{
	// Fetch the map view from the Lua object.
	const LuaProxyVTable& table = PlatformDisplayObject::GetMapViewObjectProxyVTable();
	WinRTMapViewObject *view = (WinRTMapViewObject *)luaL_todisplayobject(L, 1, table);
	if (!view)
	{
		return 0;
	}
...
int WinRTMapViewObject::SetRegion(lua_State *L)
{
	double latitude = 0;
	double longitude = 0;
...
int WinRTMapViewObject::SetCenter(lua_State *L)
{
	double latitude = 0;
	double longitude = 0;
	bool isAnimated = false;
...
int WinRTMapViewObject::RequestLocation(lua_State *L)
{
	return 0;
}

int WinRTMapViewObject::GetAddressLocation(lua_State *L)
{
...
int WinRTMapViewObject::AddMarker(lua_State *L)
{
	...
	if (lua_istable(L, 4))
	{
		...
		if (fileName) {
			...
			Rtt::WinRTPlatform *platform = NativeToJavaBridge::GetInstance()->GetPlatform();
...
int WinRTMapViewObject::RemoveMarker(lua_State *L)
{
	int markerId = 0;
...
int WinRTMapViewObject::RemoveAllMarkers(lua_State *L)
{
	// Fetch the map view from the Lua object.
	const LuaProxyVTable& table = PlatformDisplayObject::GetMapViewObjectProxyVTable();
	WinRTMapViewObject *view = (WinRTMapViewObject *)luaL_todisplayobject(L, 1, table);
...
int WinRTMapViewObject::NearestAddress(lua_State *L)
{
