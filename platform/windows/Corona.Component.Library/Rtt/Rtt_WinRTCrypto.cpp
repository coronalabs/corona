...
size_t WinRTCrypto::GetDigestLength(Algorithm algorithm) const
{
...
void WinRTCrypto::CalculateDigest(Algorithm algorithm, const Rtt::Data<const char> &data, U8 *digest) const
{
	switch (algorithm)
	{
		case kMD4Algorithm:
...
void WinRTCrypto::CalculateHMAC(
