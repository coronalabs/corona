#ifndef Rtt_WEB_BUILD_DIALOG_H
#define Rtt_WEB_BUILD_DIALOG_H
...
namespace Rtt
{
	class WebBuildDialog : public wxDialog
	{
	public:
		WebBuildDialog(wxWindow *parent, wxWindowID id, const wxString &title, const wxPoint &pos = wxDefaultPosition, const wxSize &size = wxDefaultSize, long style = wxDEFAULT_DIALOG_STYLE);
