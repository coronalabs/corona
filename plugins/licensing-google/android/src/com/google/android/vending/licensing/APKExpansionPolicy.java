...
public class APKExpansionPolicy extends Policy {
    ...
    public APKExpansionPolicy(Context context, Obfuscator obfuscator) {
        ...
        SharedPreferences sp = context.getSharedPreferences(CoronaProvider.licensing.google.LuaLoader.PREFS_FILE, Context.MODE_PRIVATE);
        mPreferences = new PreferenceObfuscator(sp, obfuscator);
        mLastResponse = Integer.parseInt(
                mPreferences.getString(PREF_LAST_RESPONSE + packageInfo.packageName, Integer.toString(Policy.RETRY)));
