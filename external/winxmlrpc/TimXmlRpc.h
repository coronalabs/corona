...
#ifndef _TimXmlRpc_H__ 
#define _TimXmlRpc_H__


// The following ifdef block is the standard way of creating macros which make exporting 
// from a DLL simpler. All files within this DLL are compiled with the WINXMLRPC_EXPORTS
// symbol defined on the command line. this symbol should not be defined on any project
// that uses this DLL. This way any other project whose source files include this file see 
// WINXMLRPC_API functions as being imported from a DLL, whereas this DLL sees symbols
// defined with this macro as being exported.
#ifdef WINXMLRPC_EXPORTS
#define WINXMLRPC_API __declspec(dllexport)
#else
#define WINXMLRPC_API __declspec(dllimport)
#endif
...
typedef void (*XmlRpcCallback)(void* context, char* status);
	...
	/* <Chris Morley> */
class WINXMLRPC_API XmlRpcException {
	std::string _message;
...
class WINXMLRPC_API XmlRpcValue {
public:
	/* <Chris Morley> */
	enum Type {
		TypeInvalid,
	...
	class WINXMLRPC_API ValueArray {
...
class WINXMLRPC_API XmlRpcClient {
	class WINXMLRPC_API XmlRpcImplementation *secret;
...
public:
	...
	void setIgnoreCookies(bool value=true);   // Added by Sonia Connolly
	...
	// Close the underlying internet connection
	void closeConnection();
};

#endif // _TimXmlRpc_H__