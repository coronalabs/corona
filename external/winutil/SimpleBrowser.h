...
//
// Modified by Corona Labs to add the following capabilties:
// - Option to disable drag-and-drop via PutRegisterAsDropTarget() method.
// - Option to disable IE shortcut keys and context menu via SetMessageTranslationEnabled() method.
////////////////////////////////////////////////////////////////////////////////////////////////////
...
public:
	...
	/// <summary>Determines if the browser control accepts dragged-and-dropped files.</summary>
	/// <remarks>This method was added by Corona Labs.</remarks>
	/// <returns>
	///  <para>Returns true if the browser control will open files or load link dragged-and-dropped onto it.</para>
	///  <para>Returns false if the control is not set up as a drag-and-drop target.</para>
	/// </returns>
	bool GetRegisterAsDropTarget();

	/// <summary>Enables/disables the web control as a drag-and-drop target for files or web links.</summary>
	/// <remarks>This method was added by Corona Labs.</remarks>
	/// <param name="value">Set true to enable drag-and-drop (the default). Set false to disable it.</param>
	void PutRegisterAsDropTarget(bool value);

	/// <summary>
	///  <para>Determines if Windows messages will be passed to the web control's TranslateAccelerator() method.</para>
	///  <para>Doing so will enable Internet Explorer style shortcut keys, tabbing, and right click menus to work.</para>
	/// </summary>
	/// <remarks>This method was added by Corona Labs.</remarks>
	/// <returns>
	///  <para>Returns true if IE browser style shortcut keys, tabbing, and right click menus are enabled.</para>
	///  <para>Returns false if disabled.</para>
	/// </returns>
	bool IsMessageTranslationEnabled();

	/// <summary>
	///  <para>Sets whether or not Win32 messages will be passed to the web control's TranslateAccelerator() method.</para>
	///  <para>Doing so will enable Internet Explorer style shortcut keys, tabbing, and right click menus to work.</para>
	/// </summary>
	/// <remarks>This method was added by Corona Labs.</remarks>
	/// <param name="value">
	///  <para>Set true to enable IE browser style shortcut keys, tabbing, and right click menus.</para>
	///  <para>Set false to disable this behavior.</para>
	/// </param>
	void SetMessageTranslationEnabled(bool value);
...
protected:
	...
	bool					_IsMessageTranslationEnabled;
